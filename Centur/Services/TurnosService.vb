...
Public Class TurnosService
    ...
    Function VerTurnosCliente(ByVal idUsuario As Integer, ByVal confirmado As Integer) As TurnoList
        Dim ds As DataSet = oTurnosDA.verTurnosCliente(idUsuario, confirmado)
