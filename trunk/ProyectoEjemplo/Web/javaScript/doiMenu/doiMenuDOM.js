...
result+='<div style="z-index:4;position:absolute;visibility:hidden;filter: blur( direction=135, strength='+this._shadow._distance+', add=1);" id="sh_'+this._id+'" align="left"><div></div></div>';else
result+='<div style="z-index:4;position:absolute;visibility:hidden;" id="sh_'+this._id+'"></div>';}
...
for(var i=0;i<=this._itemIndex;i++)
{
var result1='';result1+='<td nowrap style="z-index:4;" class="TMenuItem'+this._index+'" id="pr_'+this._items[i]._id+'"';if(this._items[i]._itemIndex >-1)
{
...
{
if(_browser._name=='IE')
result+='<div style="z-index:4;position:absolute;visibility:hidden;filter: blur( direction=135, strength='+this._parent._pop._shadow._distance+', add=1);" id="sh_'+this._id+'" align="left"><div></div></div>';else
result+='<div style="z-index:4;position:absolute;visibility:hidden;" id="sh_'+this._id+'" align="left"></div>';}	
result+='<div style="z-index:4;" class="TPopUp'+this._parent._index+'" id="'+this._id+'">';for(var i=0;i<=this._itemIndex;i++)
{
if(this._items[i]._label !='-')
{
if(this._items[i]._itemIndex >-1)
{
result+='<div style="z-index:4;" class="TPopUpItem'+this._items[i]._parent._index+'" id="di_'+this._items[i]._id+'">';result+='<table class="TPopUpItem'+this._items[i]._parent._index+'" cellspacing="0" cellpadding="0"';result+=' onmouseover="onPopItemMOver(event,this,\''+this._items[i]._id+'\','+level+','+this._items[i]._parent._name+',\''+this._items[i]._status+'\')"';result+=' onmouseout="onPopItemMOut(event,this,\''+this._items[i]._id+'\','+this._items[i]._parent._name+')"';result+=' id="pr_'+this._items[i]._id+'"><tr>'+this._items[i]._icon+this._items[i]._label+'</td>';if(this._items[i]._parent._pop._expandIcon._create)
result+='<td style="z-index:4;" class="TExpand'+this._items[i]._parent._index+'">'+this._items[i]._parent._pop._expandIcon._symbol+'</td>';}
else
{
result+='<div style="z-index:4;" class="TPopUpItem'+this._items[i]._parent._index+'">';result+='<table class="TPopUpItem'+this._items[i]._parent._index+'" cellspacing="0" cellpadding="0"';result+=' onmouseover="onPopItemMOver(event,this,\'\','+level+','+this._items[i]._parent._name+',\''+this._items[i]._status+'\')"';result+=' onmouseout="onPopItemMOut(event,this,\'\','+this._items[i]._parent._name+')"';result+=' onclick="hideAll('+this._items[i]._parent._name+');'+this._items[i]._eClick+'"';result+='><tr>'+this._items[i]._icon+this._items[i]._label+'</td>';}
result+='</tr></table>';result+='</div>';}
else
{		
if(_browser._name=='IE')
result+='<div style="z-index:4;margin-right:-2px;padding:4px 0px 4px 0px;background-color:'+this._parent._pop._itemBack._color+';"><div class="TSeparator'+this._parent._index+'"></div></div>';else
result+='<div style="z-index:4;margin-right:0px;padding:4px 0px 4px 0px;background-color:'+this._parent._pop._itemBack._color+';"><div class="TSeparator'+this._parent._index+'"></div></div>';  
}
}
result+='</div>';}
return result;}
...
function BuildStyle()
{
var result='';var tyH;var tyW;result+='<style type="text/css">';result+='table.TMenu'+this._index+'{';result+='cursor:default';result+=';visibility:hidden';result+=';z-index:4;position:'+this._position;tyW=typeof(this._width);if(tyW=='string')
{
