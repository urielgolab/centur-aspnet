namespace Datos
{
    ...
    {
        public DC() :
            base((ConfigurationManager.ConnectionStrings["Centur"].ConnectionString.Contains("Data Source") ? ConfigurationManager.ConnectionStrings["Centur"].ConnectionString : desencriptarConexion(ConfigurationManager.ConnectionStrings["Centur"].ConnectionString, ConfigurationManager.ConnectionStrings["clavePublica"].ConnectionString)), mappingSource)
            {
